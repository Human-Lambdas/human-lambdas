    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_handler.User')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_handler.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('completed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_handler.User')),
