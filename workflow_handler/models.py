...
class TaskActivity(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    created_by = models.ForeignKey(User, on_delete=models.CASCADE)
    action = models.CharField(max_length=128, choices=["created", "assigned", "completed", "saved", "comment"])
    source = models.CharField(max_length=64, choices=["api", "zapier", "csv", "manual"])
